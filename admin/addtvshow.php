...
<section class="content home">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="body">
                <form action="tvshow_record.php" class="col-md-12" enctype="multipart/form-data" id="" method="POST">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input class="form-control" name="showname" required="" type="text"/>
                    ...
                    <div class="text-left">
                        <button class="btn btn-primary btn-raised waves-effect" name="submit" type="submit" value="Upload">Add TvShow</button>
                    </div>
                </form>
            </div>
        </div>
