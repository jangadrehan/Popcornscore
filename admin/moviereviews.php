...
<section class="content home">
	<div class="container-fluid">
		<div class="block-header">
			<h2>List Of Movies Reviews</h2>
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="moviereviews.php">Movies Reviews</a></li>			
                    ...
                    <div class="body table-responsive">
                        ...
                        <table class="table table-hover">
							...
							<?php
			          				...
			          				$sql="SELECT u.username, r.rating, r.id, r.coments, m.moviename, r.user_id FROM reviews r
                                    JOIN users u ON r.user_id = u.id
                                    JOIN movie m ON r.ref_id = m.id
                                     WHERE r.ref_type='movie'";    
