...
<section class="content home">
	<div class="container-fluid">
		<div class="block-header">
			<h2>List Of TvShows Reviews</h2>
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="tvshowreviews.php">TvShows Reviews</a></li>			
                    ...
                    <div class="body table-responsive">
                        ...
                        <table class="table table-hover">
							...
							<?php
			          				...
			          				$sql="SELECT u.username, r.rating, r.id, r.coments, t.showname, r.user_id FROM reviews r
                                    JOIN users u ON r.user_id = u.id
                                    JOIN tvshow t ON r.ref_id = t.id
                                     WHERE r.ref_type='tvshow'";  
